...
-- --------------------------------------------------------------------------------------------
ALTER TABLE [QUESTIONARIO].[INFO_SOCIAL_TOPICO]  WITH CHECK ADD  CONSTRAINT [CK_INFO_SOCIAL_TOPICO_ANEXO_TOPICO_PERMITIDO] CHECK  (([ID_INFO_SOCIAL_RESPOSTA]<>(1) AND [ANEXO_TOPICO_PERMITIDO]=(0) OR [ID_INFO_SOCIAL_RESPOSTA]=(1)))
GO
ALTER TABLE [QUESTIONARIO].[INFO_SOCIAL_TOPICO] CHECK CONSTRAINT [CK_INFO_SOCIAL_TOPICO_ANEXO_TOPICO_PERMITIDO]
GO
...
-- --------------------------------------------------------------------------------------------
ALTER TABLE [QUESTIONARIO].[INFO_SOCIAL_ANEXO_TOPICO]  WITH CHECK ADD  CONSTRAINT [FK_INFO_SOCIAL_ANEXO_TOPICO_INFO_SOCIAL_FOLHA_RESPOSTA] FOREIGN KEY([ID_INFO_SOCIAL_FOLHA_RESPOSTA])
REFERENCES [QUESTIONARIO].[INFO_SOCIAL_FOLHA_RESPOSTA] ([ID_INFO_SOCIAL_FOLHA_RESPOSTA])
GO
ALTER TABLE [QUESTIONARIO].[INFO_SOCIAL_ANEXO_TOPICO] CHECK CONSTRAINT [FK_INFO_SOCIAL_ANEXO_TOPICO_INFO_SOCIAL_FOLHA_RESPOSTA]
GO
