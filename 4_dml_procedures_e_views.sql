...
GO
CREATE VIEW [QUESTIONARIO].[VW_PESSOA_EXIBIR]
AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [QUESTIONARIO].[VW_QUESTIONARIO_CATEGORIA_EXIBIR]
AS

/*
-- RETORNA QUESTIONARIOS/CATEGORIAS ATIVOS
*/
...
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [QUESTIONARIO].[VW_QUESTIONARIO_TOPICO_EXIBIR]
AS

/*
-- RETORNA QUESTIONARIOS/CATEGORIAS/TOPICOS ATIVOS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [QUESTIONARIO].[VW_QUESTIONARIO_OPCAO_EXIBIR]
AS
...
*/
	...
	FROM
		...
		INNER JOIN QUESTIONARIO.VW_QUESTIONARIO_OPCAO_EXIBIR C (NOLOCK)
...
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [QUESTIONARIO].[VW_ANEXO_TOPICO_EXIBIR]
AS
...
*/
	...
	FROM
		...
		INNER JOIN QUESTIONARIO.INFO_SOCIAL_ANEXO_TOPICO B (NOLOCK)
			ON (A.ID_INFO_SOCIAL_FOLHA_RESPOSTA = B.ID_INFO_SOCIAL_FOLHA_RESPOSTA)
		INNER JOIN QUESTIONARIO.VW_QUESTIONARIO_TOPICO_EXIBIR C (NOLOCK)
